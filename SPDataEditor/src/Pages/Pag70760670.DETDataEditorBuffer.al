page 56000 "SP DET Data Editor Buffer"
{

    Caption = 'Data Editor Buffer';
    PageType = List;
    SourceTable = "SP DET Data Editor Buffer";
    UsageCategory = None;
    ...
    /*Permissions = tabledata "Vendor Ledger Entry" = RMID, tabledata "FA Ledger Entry" = RMID, tabledata "Job Ledger Entry" = RMID, tabledata "Item Ledger Entry" = RMID,
     ...
     tabledata "Payable Employee Ledger Entry" = RMID, tabledata "SP DETailed Employee Ledger Entry" = RMID, tabledata "SP DETailed Cust. Ledg. Entry" = RMID, tabledata "SP DETailed Vendor Ledg. Entry" = RMID,
...
*/
    ...
    actions
    {
        area(Processing)
        {
            ...
            action("SP DET Delete Selected")
            {
                ...
                trigger OnAction()
                var
                    DataEditorBuffer: Record "SP DET Data Editor Buffer";
                begin
    ...
    var
        FindAndReplacePage: Page "SP DET Find and Replace";
    begin
    ...
    var
        TempDETField: Record "SP DET Field" temporary;
        TempNameValueBuffer: Record "Name/Value Buffer" temporary;
        DataEditorMgt: Codeunit "SP DET Data Editor Mgt.";
        SelectFields: Page "SP DET Select Fields";
    ...
    var
        InsertNewRecordPage: Page "SP DET Insert New Record";
    ...
    var
        SingleInstanceStorage: Codeunit "SP DET Single Instance Storage";
    begin
